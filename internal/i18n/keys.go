...
// MessageID constants for all i18n message keys.
// Grouped by module to prevent key typos / 所有 i18n 消息的 key 常量，按模块分组，避免 key 拼写错误.
...
const (
	...
	MsgDevReinstallSuccess      MessageID = "DevReinstallSuccess"
	...
	// --- service ---
	MsgServiceInstalled   MessageID = "ServiceInstalled"
	MsgServiceStartHint   MessageID = "ServiceStartHint"
	MsgServiceUninstalled MessageID = "ServiceUninstalled"
	MsgServiceStarted     MessageID = "ServiceStarted"
	MsgServiceStopped     MessageID = "ServiceStopped"
	MsgServiceRestarted   MessageID = "ServiceRestarted"
	MsgServiceStatus      MessageID = "ServiceStatus"
	MsgServicePackaged    MessageID = "ServicePackaged"
	...
	ErrPluginUpgradeStop         = "plugin.err_upgrade_stop"
	ErrPluginUpgradeSave         = "plugin.err_upgrade_save"
	...
	// Broker provisioner errors (used by callers after matching sentinel errors) / Broker 供应器错误（调用方用，匹配 sentinel error 后展示）
	...
	// Doctor
	MsgDoctorCheckDocker         = "doctor.check_docker"
	MsgDoctorDockerOK            = "doctor.docker_ok"
	ErrDoctorDockerFail          = "doctor.err_docker_fail"
	MsgDoctorCheckService        = "doctor.check_service"
	MsgDoctorServiceInstalled    = "doctor.service_installed"
	MsgDoctorServiceNotInstalled = "doctor.service_not_installed"
	MsgDoctorCheckContainer      = "doctor.check_container"
	MsgDoctorContainerOK         = "doctor.container_ok"
	MsgDoctorContainerFail       = "doctor.container_fail"
	MsgDoctorCheckRabbitMQHealth = "doctor.check_rabbitmq_health"
	MsgDoctorRabbitMQHealthOK    = "doctor.rabbitmq_health_ok"
	MsgDoctorRabbitMQHealthFail  = "doctor.rabbitmq_health_fail"
	MsgDoctorAllOK               = "doctor.all_ok"
	MsgDoctorHasIssues           = "doctor.has_issues"
)
